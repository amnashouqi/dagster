...
![Peered asset in Dagster UI](../../../experimental/dagster-airlift/examples/tutorial-example/images/peer.svg)
...
![Materialized peer asset in Dagster UI](../../../experimental/dagster-airlift/examples/tutorial-example/images/peer_materialize.svg)
...
![Observed asset graph in Dagster](../../../experimental/dagster-airlift/examples/tutorial-example/images/observe.svg)
...
![Partitioned Materialization in Dagster](../../../experimental/dagster-airlift/examples/tutorial-example/images/partitioned_mat.png)
...
![Migration state rendering in Airflow UI](../../../experimental/dagster-airlift/examples/tutorial-example/images/state_in_airflow.png)
...
```yaml file=../../experimental/dagster-airlift/examples/tutorial-example/tutorial_example/snippets/dbt_proxied.yaml
tasks:
  - id: load_raw_customers
    proxied: False
  - id: build_dbt_models
...
![dbt build executing in Dagster](../../../experimental/dagster-airlift/examples/tutorial-example/images/proxied_dag.png)
...
```python file=../../experimental/dagster-airlift/examples/tutorial-example/tutorial_example/dagster_defs/stages/migrate.py
import os
from pathlib import Path
...
```yaml file=../../experimental/dagster-airlift/examples/tutorial-example/tutorial_example/snippets/all_proxied.yaml
tasks:
  - id: load_raw_customers
    proxied: True
  - id: build_dbt_models
...
```python file=../../experimental/dagster-airlift/examples/tutorial-example/tutorial_example/dagster_defs/stages/migrate_with_check.py
import os
from pathlib import Path
...
![Before DAG proxying](../../../experimental/dagster-airlift/examples/tutorial-example/images/before_dag_override.svg) ![After DAG proxying](../../../experimental/dagster-airlift/examples/tutorial-example/images/after_dag_override.svg)
