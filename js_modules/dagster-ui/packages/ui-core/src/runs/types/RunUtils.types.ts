...
export type LaunchMultipleRunsMutationVariables = Types.Exact<{
  executionParamsList: Array<Types.ExecutionParams>;
}>;
...
export type LaunchMultipleRunsMutation = {
  ...
  launchMultipleRuns:
    ...
    | {__typename: 'InvalidSubsetError'; message: string}
    | {
        __typename: 'LaunchMultipleRunsSuccess';
        runs: Array<{
...
export const LaunchPipelineReexecutionVersion =
  'd21e4ecaf3d1d163c4772f1d847dbdcbdaa9a40e6de0808a064ae767adf0c311';
